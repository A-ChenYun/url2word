...
*/
    ...
    public static String post(String param) throws URISyntaxException, IOException {
        ...
        URI url = new URI(Consts.POST_URL);
        post.setURI(url);
        ...
        //log.info("1111"+str+"22222");
        //System.out.println("1111111111111"+response.toString()+"1111111");
            ...
            *//*String str;
            try {
                *//**//*读取服务器返回过来的json字符串数据*//**//*
                ...
                //System.out.println("qqqqqqqqqqwwwwwwwwwwwqqqqqqq"+str);
                return str;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
